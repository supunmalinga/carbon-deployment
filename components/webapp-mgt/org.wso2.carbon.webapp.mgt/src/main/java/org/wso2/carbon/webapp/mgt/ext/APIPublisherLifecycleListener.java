...
//        Set<String> entityClasses = getAnnotatedClassesStandardContext(context,
//                Path.class);
    ...
    public void addApi(StandardContext context, AppInfo appInfo) {
        if(appInfo != null && appInfo.isManagedApi()){
            if(isAPIProviderReady()){
                ...
                System.out.println("XXXXXXXXXXXXXXXXXXXXXXXXXXXX apiProvider == " + apiProvider);
...
//    }
    ...
    private static void showAPIinfo(ServletContext context, Class<?> clazz) {
        ...
        if (context != null) {
            System.out.println("................................ Application Context root = "
                    + context.getContextPath());
        }
        System.out.println("................................ API Root  Context = "
                + root);
        System.out.println("................................ API Sub Context List ");
